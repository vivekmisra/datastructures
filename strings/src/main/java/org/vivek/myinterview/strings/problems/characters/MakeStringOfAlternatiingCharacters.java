...
public class MakeStringOfAlternatiingCharacters {
	...
	public static void main(String[] args) {
		String s = "beabeefeab";
		String str = s.replaceAll("[^ba]", "");// match everything except
												// a|b|ab|ba and replace then
												// with blank
		// above regex will match e[1] e[4] e[5] f[6] e[7] from string str, [i]
		// representing index i and replacing these with "" will return babab
