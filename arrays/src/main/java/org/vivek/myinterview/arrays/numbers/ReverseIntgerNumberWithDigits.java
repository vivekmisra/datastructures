...
public class ReverseIntgerNumberWithDigits {
	...
	public static void main(String[] args) {
		...
		System.out.println(" getArrayOfDigitsWithoutChangingOrder(" + 678 + ")"
				+ Arrays.deepToString(getArrayOfDigitsWithoutChangingOrder(678)));
		System.out
				.println(" getIntegerNumberWithDigits(" + Arrays.deepToString(getArrayOfDigitsWithoutChangingOrder(678))
						+ ")=" + getIntegerNumberWithDigits(getArrayOfDigitsWithoutChangingOrder(678)));
	}
