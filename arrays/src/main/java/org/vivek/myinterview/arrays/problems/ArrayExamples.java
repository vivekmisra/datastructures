...
public class ArrayExamples {
	...
	public static void main(String[] args) {
		int nums[] = {3, 2, 1, 2, 1, 4, 5, 8, 6, 7, 4, 2};
	   System.out.println(maxSpan( nums));//Output: 10
	// maximum distance for 2 is 11-1 = 10 
	// maximum distance for 1 is 4-2 = 2 
	// maximum distance for 4 is 10-5 = 5 

	}
//https://github.com/ozelentok/CodingBat-Solutions/blob/master/Java/Array-3.java
	...
	// of 3's and 4's, every 3 has a number after it that is not a 3 or 4, and a 3
