 ...
 * @author Tushar Roy
 *
 *         Give two arrays of same size consisting of 0s and 1s find span (i, j)
 *         such that sum of input1[i..j] = sum of input2[i..j]
 *
...
public class LongestSameSumSpan {
	...
	public static void main(String args[]) {
		...
		//System.out.println(lsss.longestSpan2(input1, input2));
	}
