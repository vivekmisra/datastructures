...
import org.vivek.myinterview.graph.core.impl.Edge;
import org.vivek.myinterview.graph.core.impl.Graph;
import org.vivek.myinterview.graph.core.impl.Vertex;
...
public class AllCyclesInDirectedGraphJohnson {
   ...
   private Optional<Vertex<Integer>> leastIndexSCC(List<Set<Vertex<Integer>>> sccs, Graph<Integer> subGraph) {
    ...
    private boolean findCyclesInSCG(
        ...
        for (Edge<Integer> e : currentVertex.getConnectingEdgeList()) {
